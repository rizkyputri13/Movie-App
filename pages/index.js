...
export default function App() {
  ...
  const url =
    "https://api.themoviedb.org/3/movie/popular?api_key=49fe8fdb9ba53cb9feefc4143c5a3e7f&language=en-US&page=1";
  ...
  const handleSubmit = (event) => {
    ...
    fetch(
      `https://api.themoviedb.org/3/movie/popular?api_key=49fe8fdb9ba53cb9feefc4143c5a3e7f&language=en-US&page=1/search?q=${searchTerm}`
    )
      ...
      <div className="min-h-full">
        ...
        {/* <header className="bg-white shadow">
          <div className="mx-auto max-w-7xl py-6 px-4 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-extrabold dark:text-white py-6">
              Box Movies
            </h1>
          </div>
        </header> */}
